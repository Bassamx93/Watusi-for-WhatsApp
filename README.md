...
* (Option 1) Download IPA file from here and follow the below [Sideloading with AltStore](#sideloading-with-altstore) instructions to sign and install the app from your computer. You can also follow the [Sideloading as a linked device](#sideloading-as-linked-device-push-notifictions--icloud-backup) tutorial to sideload a duplicate and still receive push notifications from original.
    ...
    | ------------------ |:---------:|:------:|:------:|
    | [WhatsApp][WA-SL] | net.whatsapp.WhatsApp | 26.36.74 | 1.3.24 |
    | [WhatsApp Duplicate][WA-SL-Duplicate] | com.fouadraheb.watusi | 26.36.74 | 1.3.24 |
    | [WA Business][SMB-SL] | net.whatsapp.WhatsAppSMB | 26.36.74 | 1.3.24 |
    | [WA Business Duplicate][SMB-SL-Duplicate] | com.fouadraheb.watusiSMB | 26.36.74 | 1.3.24 |
...
* If you are on <b>iOS 14 - 16.6.1</b> (iPhone X - A11 and older) or <b>iOS 14 - 16.6 beta 1</b> (iPhone 11 and newer), install with TrollStore to receive push notifications and use iCloud features:
    ...
    * Install to overwrite original WhatsApp
    ...
    | Application | Bundle | Version | Watusi 3 |
    | ------------------ |:---------:|:------:|:------:|
    | [WhatsApp][WA-TS] | net.whatsapp.WhatsApp | 26.36.74 | 1.3.24 |
    | [WA Business][SMB-TS] | net.whatsapp.WhatsAppSMB | 26.36.74 | 1.3.24 |
    | [WhatsApp Duplicate][WA-TS-Duplicate] | com.fouadraheb.watusi | 26.36.74 | 1.3.24 |
    | [WA Business Duplicate][SMB-TS-Duplicate] | com.fouadraheb.watusiSMB | 26.36.74 | 1.3.24 |
    ...
    | Application | Bundle | Version | Watusi 3 |
    | ------------------ |:---------:|:------:|:------:|
    | [WhatsApp][WA-TS-NoPlugins] | net.whatsapp.WhatsApp | 26.36.74 | 1.3.24 |
    | [WA Business][SMB-TS-NoPlugins] | net.whatsapp.WhatsAppSMB | 26.36.74 | 1.3.24 |
